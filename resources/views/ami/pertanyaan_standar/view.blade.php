                    ...
                    <table id="example3" class="display" style="min-width: 845px">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a href="#" class="btn btn-secondary shadow btn-xs sharp me-1"><i class="fa fa-file-invoice"></i></a>
                                            <a href="{{ url('/standar/list_pertanyaan') }}" class="btn btn-primary shadow btn-xs sharp me-1"><i
