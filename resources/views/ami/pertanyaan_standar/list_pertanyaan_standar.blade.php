    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">List Pertanyaan Standar</h4>
                <a href="#" class="btn btn-rounded btn-secondary btn-xs"><span
                        class="btn-icon-start text-secondary"><i class="fa fa-plus color-secondary"></i>
                    </span>Add</a>
            </div>
            <div class="card-body">
