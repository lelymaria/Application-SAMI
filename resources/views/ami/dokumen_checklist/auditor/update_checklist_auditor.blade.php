        ...
        <form action="{{ url('/ami/checklist_audit/update/' . $checkListAudit->id) }}" method="post">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 row">
                        <label class="col-lg-2 col-form-label" for="validationCustom02">Tanggal Input Checklist
                        </label>
                        <div class="col-lg-6">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" rows="5" name="catatan_khusus" placeholder="Masukan Catatan Khusus...">{{ $checkListAudit->catatan_khusus }}</textarea>
                    </div>
                    <div class="mb-3">
                        <label class="col-lg-2 col-form-label" for="validationCustom02">Hasil Observasi
                        </label>
                        <textarea class="form-control" rows="5" name="hasil_observasi" placeholder="Masukan Hasil Observasi...">{{ $checkListAudit->hasil_observasi }}</textarea>
                    </div>
                </div>
            </div>
        </form>
