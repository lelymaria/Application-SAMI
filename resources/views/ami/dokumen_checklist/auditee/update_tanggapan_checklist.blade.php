...
@endif
    ...
    <div class="col-12">
        <form action="{{ url('/ami/tanggapan_audit/update/' . $tanggapanAudit->id) }}" method="post">
            @csrf
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" rows="10" name="list_pertanyaan_standar" disabled>{{ $tanggapanAudit->pertanyaanStandar->list_pertanyaan_standar }}</textarea>
                    </div>
                    @if ($tanggapanAudit->checklistAudit)
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-check form-check-inline">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="kesesuaian" disabled
                                            value="ya"
                                            {{ $tanggapanAudit->checklistAudit?->kesesuaian == 'ya' ? 'checked' : '' }}>Ya
                                    </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="kesesuaian" disabled
                                            value="tidak"
                                            {{ $tanggapanAudit->checklistAudit?->kesesuaian == 'tidak' ? 'checked' : '' }}>Tidak
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" rows="5" name="catatan_khusus" disabled>{{ $tanggapanAudit->checklistAudit?->catatan_khusus }}</textarea>
                        </div>
                        <div class="mb-3">
