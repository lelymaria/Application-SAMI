        ...
        <form action="{{ url('/ami/tanggapan_audit/create/'.$pertanyaan->id) }}" method="post">
            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="col-lg-6">
                            <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="kesesuaian" disabled value="ya" {{ $pertanyaan->cheklistAudit?->kesesuaian == 'ya' ? 'checked' : '' }}>Ya
                                </label>
                            </div>
                            <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="kesesuaian" disabled value="tidak" {{ $pertanyaan->cheklistAudit?->kesesuaian == 'tidak' ? 'checked' : '' }}>Tidak
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    @endif
                    <div class="mb-3">
                        <label class="col-lg-2 col-form-label" for="validationCustom02">Tanggapan Auditee<span class="text-danger">*</span>
                        </label>
                        <textarea class="form-control" rows="5" name="tanggapan_auditee" placeholder="Masukan Tanggapan..."></textarea>
                    </div>
                </div>
            </div>
        </form>
