...
@section('content')
                ...
                <div class="profile-tab">
                    <div class="custom-tab-1">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item"><a href="{{ url('/dokumentasiRtm/' . $undanganRtm->id . '/notulensi_rtm') }}" class="nav-link">Notulensi</a>
                            </li>
                        </ul>
                        <div class="tab-content">
                            <div id="foto_kegiatan" class="tab-pane fade active show">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <div class="form-file">
                                                                <input type="file" class="form-file-input form-control"
                                                                    name="foto_kegiatan_rtm[]" multiple>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="row">
                                    @foreach ($foto_kegiatan_rtm as $kegiatan)
                                                ...
                                                <div class="card-body">
                                                    <div class="new-arrival-product">
                                                        <div class="bootstrap-carousel">
                                                            <div id="carouselExampleIndicators2" class="carousel slide"
                                                                ...
                                                                <div class="carousel-indicators">
                                                                    @php
                                                                        $file_foto_kegiatan_rtm = json_decode($kegiatan->file_foto_kegiatan_rtm);
                                                                    @endphp
                                                                    @foreach ($file_foto_kegiatan_rtm as $index => $foto)
                                                                        <button type="button"
                                                        ...
                                                        <div class="new-arrival-content text-left mt-3">
                                                            <p>
                                                                {{ $kegiatan->caption_foto_kegiatan_rtm }}
                                                            </p>
                                                        ...
                                                        <div class="d-flex justify-content-end">
                                                            ...
                                                            <form
                                                                action="{{ url('/dokumentasiRtm/foto_kegiatan_rtm/' . $kegiatan->id) }}"
                                                                method="post">
                                                                @method('delete')
                                                                @csrf
    ...
    {{-- update --}}
    <div class="modal fade" id="updateFotoRtm">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="editModalBody">
                    <div class="form-validate">
                        <form class="needs-validation" novalidate="" action="{{ url('/dokumentasiRtm/foto_kegiatan_rtm/'.$undanganRtm->id) }}" method="post"
