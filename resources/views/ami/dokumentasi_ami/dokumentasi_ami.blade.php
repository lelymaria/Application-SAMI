            ...
            <div class="profile-tab">
                <div class="custom-tab-1">
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a href="#absensi" data-bs-toggle="tab" class="nav-link active show">Absensi</a>
                        </li>
                    ...
                    <div class="tab-content">
                        <div id="absensi" class="tab-pane fade active show">
                            @include('ami.dokumentasi_ami.absensi.absensi_ami')
                        </div>
                        <div id="foto-kegiatan" class="tab-pane fade">
                            @include('ami.dokumentasi_ami.foto_kegiatan.foto_kegiatan_ami')
                        </div>
                        <div id="notulensi" class="tab-pane fade">
                            @include('ami.dokumentasi_ami.notulensi.notulensi_ami')
                        </div>
                    </div>
                </div>
                <!-- Modal -->
