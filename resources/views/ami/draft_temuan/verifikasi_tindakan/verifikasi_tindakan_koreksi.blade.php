...
@endif
    ...
    <div class="col-12">
        <form action="{{ url('/ami/verifikasi_ami/create/'.$standar->id) }}" method="post">
            @csrf
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @if ($standar->uraianTemuanAmi)
                        <div class="mb-3">
                            <label class="col-lg-2 col-form-label" for="validationCustom02">Uraian Ketidaksesuaian </label>
