                ...
                <div class="profile-head">
                    ...
                    <div class="profile-info">
                        <div class="profile-photo">
                            <img src="{{ asset($update_akun_kepalaP4mp->user->foto_profile) }}" class="img-fluid rounded-circle"
                                alt="" style="width: 100px; height: 100px">
                        </div>
                        <div class="profile-details">
                            <div class="profile-name px-3 pt-2">
                                <h4 class="text-primary mb-0">{{ $update_akun_kepalaP4mp->nama }}</h4>
                                <p>{{ $update_akun_kepalaP4mp->user->levelRole->name }}</p>
                            </div>
                            <div class="profile-email px-2 pt-2">
                                <h4 class="text-muted mb-0">{{ $update_akun_kepalaP4mp->email }}</h4>
                                <p>Email</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-validation">
                        <form class="needs-validation" novalidate="" action="{{ url('/manage_user/kepalaP4mp/'. $update_akun_kepalaP4mp->id) }}"
                        method="post">
                        @csrf
                            <div class="row">
                                <div class="mb-3">
                ...
                <div class="card-body">
                    <div class="form-validation">
                        <form class="needs-validation" novalidate=""
                            action="{{ url('/manage_user/edit_password/' . $update_akun_kepalaP4mp->user->id) }}" method="post">
                            @csrf
                            @method('put')
                            <div class="row">
                                <div class="col-xl-6">
