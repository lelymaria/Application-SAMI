                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table id="example3" class="table table-responsive-md"
                                                    ...
                                                    <tbody>
                                                        @forelse ($akun_auditor as $index => $anggota_auditor)
                                                            <tr>
                                                                <td>{{ ($akun_auditor->currentPage() - 1) * $akun_auditor->perPage() + $index + 1 }}
                                                                </td>
                                                                <td>{{ $anggota_auditor->akunAuditor?->nama }}</td>
                                                                <td>{{ $anggota_auditor->nip }}</td>
                                                                <td>{{ $anggota_auditor->akunAuditor?->email }}</td>
                                                                <td><strong>{{ $anggota_auditor->levelRole->name }}</strong>
                                                                </td>
                                                                <td>
                                                                    @if ($anggota_auditor->akunAuditor?->dataProdi)
                                                                        {{ $anggota_auditor->akunAuditor?->dataProdi->nama_prodi }}
                                                                    @else
                                                                        {{ $anggota_auditor->akunAuditor?->layananAkademik->nama_layanan }}
                                                                    @endif
                                                                </td>
                                                                <td>
                                                                    <div class="d-flex">
                                                                        <div class="d-flex">
                                                                            <a href="{{ url('/manage_user/anggota_auditor_edit/' . $anggota_auditor->id) }}"
                                                                                class="btn btn-primary shadow btn-xs sharp me-1 btn-edit"><i
                                                                                    class="fas fa-pencil-alt"></i></a>
                                                                            <button
                                                                                class="btn btn-danger shadow btn-xs sharp btn-delete"
                                                                                data-url="{{ url('/manage_user/anggota_auditor/' . $anggota_auditor->id) }}"><i
