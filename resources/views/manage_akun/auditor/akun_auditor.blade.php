                    ...
                    <table id="example3" class="display" style="min-width: 845px">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><a href="javascript:void(0);"><strong>Lead Auditor</strong></a></td>
                                <td><a href="javascript:void(0);"><strong>auditor</strong></a></td>
                                <td>Prodi KP</td>
                                <td>
                                    <div class="d-flex">
                                        <a href="/updateakunauditor" class="btn btn-primary shadow btn-xs sharp me-1"><i
