...
@section('content')
    ...
    <div class="row page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="/akunauditee">Auditee</a></li>
                    ...
                    <div class="profile-info">
                        ...
                        <div class="profile-details">
                            ...
                            <div class="profile-email px-2 pt-2">
                                <h4 class="text-muted mb-0">{{ $update_akun_operator->email }}m</h4>
                                <p>Email</p>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="validationCustom02"
                                                name="email" value="{{ $update_akun_operator->email }}">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="validationCustom03"
                                                name="nip" value="{{ $update_akun_operator->user->nip }}">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="validationCustom03"
                                                name="nama" value="{{ $update_akun_operator->nama }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6">
